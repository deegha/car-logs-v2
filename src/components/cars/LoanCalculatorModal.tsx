            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 sm:px-6 sm:py-5">
              ...
              {result ? (
                <>
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-3">
                    <div className="col-span-2 rounded-xl border border-primary-200 bg-primary-50 p-4 sm:col-span-1">
                      <p className="text-xs font-medium tracking-wider text-primary-600 uppercase">
                        Monthly Payment
                      </p>
                      <p className="mt-1 text-2xl font-bold text-primary-700 sm:text-xl">
                        {fmt(result.monthlyPayment)}
                      </p>
                    </div>
                    <div className="rounded-xl border border-border bg-background-subtle p-4">
                      <p className="text-xs font-medium tracking-wider text-foreground-muted uppercase">
                        Total Payment
                      </p>
                      <p className="mt-1 text-base font-bold text-foreground sm:text-xl">
                  ...
                  <div className="mt-5">
                    ...
                    <div className="overflow-x-auto rounded-xl border border-border">
                      <table className="w-full min-w-[480px] text-xs sm:text-sm">
                        <thead>
                          <tr className="border-b border-border bg-background-subtle text-left text-xs font-medium tracking-wider text-foreground-muted uppercase">
                        ...
                        <tbody>
                          {result.schedule.map((row) => (
                            ...
                            >
                              <td className="px-3 py-2 font-medium text-foreground-muted">
                                {row.month}
                              </td>
                ...
                <p className="mt-6 text-sm text-foreground-muted">
                  Enter valid values above to see the calculation.
                </p>
              )}
