...
export async function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-background shadow-sm" style={{ paddingTop: "env(safe-area-inset-top)" }}>
      <div className="mx-auto flex h-14 max-w-7xl items-center gap-3 px-4 sm:h-16 sm:gap-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-6 text-sm font-medium text-foreground-muted sm:flex">
          ...
          <Link href="/sell" className="hover:text-foreground">Sell Your Car</Link>
        </nav>
